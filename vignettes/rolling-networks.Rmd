...
change in dynamics, not differences between persons.
...
penalized two-step estimator in each window — lasso-penalized lagged
...
The first sparse window retains no temporal edges, matching the full-series
graphical fit for the same student. Its contemporaneous layer keeps
