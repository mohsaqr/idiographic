...
Saqr M, López-Pernas S (2026). *idiographic: Idiographic Person-Specific
and Heterogeneous Complex Networks*. R package version 0.3.2,
<https://github.com/mohsaqr/idiographic>.

    @Manual{,
      title = {idiographic: Idiographic Person-Specific and Heterogeneous Complex Networks},
