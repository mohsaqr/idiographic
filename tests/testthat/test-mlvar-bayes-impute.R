# Within-model imputation (data augmentation) for build_mlvar_bayes.
...
test_that("impute=TRUE equals impute=FALSE on complete data (no cells to fill)", {
  ...
  a <- build_mlvar_bayes(d, vars = c("V1", "V2"), id = "id", beep = "beep",
                         temporal = "random", impute = TRUE,  n_iter = 800,
                         n_chains = 1, seed = 9)
  b <- build_mlvar_bayes(d, vars = c("V1", "V2"), id = "id", beep = "beep",
